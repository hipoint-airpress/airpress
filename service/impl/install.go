...
如果你看到了这一篇文章，那么证明你已经安装成功了，感谢使用 [AirPress](https://github.com/hipoint-airpress/airpress) 进行创作，希望能够使用愉快。
...
`
	...
	<p>如果你看到了这一篇文章，那么证明你已经安装成功了，感谢使用 <a href="https://github.com/hipoint-airpress/airpress" target="_blank">AirPress</a> 进行创作，希望能够使用愉快。</p>
...
func (i installServiceImpl) createDefaultComment(ctx context.Context, post *entity.Post) (*entity.Comment, error) {
	...
	comment := &entity.Comment{
		...
		Author:            "AirPress",
		AuthorURL:         "https://github.com/hipoint-airpress/airpress",
		Content:           content,
